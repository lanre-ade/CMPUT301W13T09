 ...
 * ingredientListModel is a class that stores a list of ingredients. These ingredients are from
 * ingredientModel class and stored in a ArrayList class. The constructor takes in a single ingredient
 * and appends it to a blank ingredient List (ingred_list). The ingredientListModel has methods
 * getLength, getingredientListDesc, getingredientListName.
 */
public class ingredientListModel {
	private ArrayList<ingredientModel> ingred_list = new ArrayList<ingredientModel>();

	/** Constructor?
	 * 	TODO Fix this cause it won't work
	 * @param ingred : ....???
	 */
